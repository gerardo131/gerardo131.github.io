...
<div  class="st-k2-view-item <?php echo $viewClass; ?><?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Latest items from author -->
	<div class="st-article-latest-from">
		...
		<div class="row-fluid clearfix">
			...
			<div class="span4">
				<div class="inner">
					<div class="image">
						<a href="<?php echo $item->link ?>"><img src="<?php echo $item->imageSmall; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" /></a>
					</div>
					<div class="content"><a class="title"  href="<?php echo $item->link ?>"><?php echo $item->title; ?></a></div>
				</div>
			</div>
			<?php endforeach; ?>
		</div>
